					...
					<div id="store.success" class="alert alert-success" style="<c:choose><c:when test="${success!=null}">display:block;</c:when><c:otherwise>display:none;</c:otherwise></c:choose>"><s:message code="message.success" text="Request successfull"/></div>    
	                 ...
	                 <div class="control-group">
	                  ...
	                  <div class="control-group">
	                        ...
	                        <div class="controls">
	                        					<input id="dateBusinessSince" name="dateBusinessSince" value="${store.dateBusinessSince}" class="small" type="text" data-date-format="<%=com.salesmanager.common.business.constants.Constants.DEFAULT_DATE_FORMAT%>" data-datepicker="datepicker">
