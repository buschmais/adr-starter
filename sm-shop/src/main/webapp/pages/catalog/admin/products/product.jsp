  					 ...
  					 <div class="tab-content">
    					...
    					<div class="tab-pane active" id="catalogue-section">
								...
								<c:if test="${product.product.id!=null && product.product.id>0}">
									...
									<jsp:include page="/pages/catalog/admin/products/product-menu.jsp" />
								</c:if>	
				...
				<br/><br/>
						...
						<form:hidden path="product.id" />
                  		...
                  		<div class="control-group">
	                        ...
	                        <div class="controls">
	                        		 <input id="dateAvailable" name="dateAvailable" value="${product.dateAvailable}" class="small" type="text" data-date-format="<%=com.salesmanager.common.business.constants.Constants.DEFAULT_DATE_FORMAT%>" data-datepicker="datepicker">
	                                 <script type="text/javascript">
