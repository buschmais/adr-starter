...
<div class="tabbable">
				...
				<div class="alert alert-info">
				 ...
				 <c:set var="gridHeaderContainer" value="/pages/catalog/admin/products/featured-gridHeader.jsp" scope="request"/>
				 <c:set var="canRemoveEntry" value="true" scope="request"/>

            	 <jsp:include page="/pages/catalog/admin/products/product-container.jsp"></jsp:include>
