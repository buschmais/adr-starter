...
public interface SearchFacade {
	 ...
	 * @return
	 */
	public SearchProductList copySearchResponse(SearchResponse searchResponse, MerchantStoreInfo store, int start, int count, LanguageInfo language) throws Exception;
