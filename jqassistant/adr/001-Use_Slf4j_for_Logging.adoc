...
[source,cypher,role="constraint",requiresConcepts="preparation:ShopizerFiles,preparation:Logger,preparation:Slf4j",severity=minor]
...
[source,cypher,role="constraint",requiresConcepts="preparation:ShopizerFiles",severity=minor]
